...
class UI_Window():
    ...
    def __init__(self):
        ...
        self.canvas2 = tk.Canvas(self.turing_tab, width=500, height=310)
        ...
        self.drawcircle(self.canvas2, 180, 280, 6, 'red')
        self.drawcircle(self.canvas2, 204, 300, 6, 'red')
        self.drawcircle(self.canvas2, 40, 280, 6, 'red')
        self.drawcircle(self.canvas2, 42, 260, 6, 'red')
        self.drawcircle(self.canvas2, 45, 240, 6, 'red')
        self.drawcircle(self.canvas2, 49, 220, 6, 'red')
        self.drawcircle(self.canvas2, 54, 200, 6, 'red')
        self.drawcircle(self.canvas2, 60, 180, 6, 'red')
        self.drawcircle(self.canvas2, 68, 160, 6, 'red')
        self.drawcircle(self.canvas2, 78, 140, 6, 'red')
        self.drawcircle(self.canvas2, 90, 120, 6, 'red')
        self.drawcircle(self.canvas2, 104, 100, 6, 'red')
        self.drawcircle(self.canvas2, 120, 80, 6, 'red')
        self.drawcircle(self.canvas2, 138, 60, 6, 'red')
        self.drawcircle(self.canvas2, 158, 40, 6, 'red')
        self.drawcircle(self.canvas2, 180, 20, 6, 'red')
